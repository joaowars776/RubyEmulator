...
public class PlayerDao {
    ...
    public static void updateHotelAlerts(final boolean value, int playerId) {
        ...
        try {
            ...
            preparedStatement = sqlConnection.prepareStatement("UPDATE player_settings SET disable_hotel_alerts = ? WHERE player_id = ?");
    ...
    public static void updateHotelAlertsLinks(final boolean value, int playerId) {
        ...
        try {
            ...
            preparedStatement = sqlConnection.prepareStatement("UPDATE player_settings SET disable_hotel_alerts_links = ? WHERE player_id = ?");
            preparedStatement.setString(1, value ? "1" : "0");
            preparedStatement.setInt(2, playerId);
