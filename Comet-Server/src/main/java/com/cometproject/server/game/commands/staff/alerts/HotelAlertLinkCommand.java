...
public class HotelAlertLinkCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        NetworkManager.getInstance().getSessions().broadcastHotelAlertLink(new AdvancedAlertMessageComposer(Locale.getOrDefault("command.hotelalertlink.title", "Alerta"), this.merge(params, 1) + "<br><br>- <b>" + client.getPlayer().getData().getUsername() + "</b>", Locale.getOrDefault("command.hotelalertlink.buttontitle", "+info"), baseLink + link, "hal"));
