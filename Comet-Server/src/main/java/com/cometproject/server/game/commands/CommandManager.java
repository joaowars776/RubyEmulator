...
public class CommandManager implements Initialisable {
    ...
    private void loadUserCommands() {
        ...
        this.addCommand(Locale.getOrDefault("command.redeem_clothes.name", "roupas"), new RedeemClothesCommand());
    ...
    private void loadStaffCommands() {
        ...
        this.addCommand(Locale.getOrDefault("command.ignore_invites.name", "ignoreinvites"), new IgnoreInvitesCommand());
