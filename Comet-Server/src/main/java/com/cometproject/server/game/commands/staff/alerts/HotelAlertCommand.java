...
public class HotelAlertCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] message) {
        ...
        NetworkManager.getInstance().getSessions().broadcastHotelAlert(new AlertMessageComposer(String.format("Alerta da Equipe Ruby:<br><br>%s<br><br>- %s", realMessage, client.getPlayer().getData().getUsername())));
